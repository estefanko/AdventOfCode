...
for entry in total_ids_to_check_split:
    ...
    for number in entry_array:
        ...
        x = 0 #while loop counter
        initial_index_number = 0
        comparison_equidistant_number = int(len(number_string_character_array)/2)
        ...
        #Add numbers if the number to be evaluated is made of duplicate numbers
